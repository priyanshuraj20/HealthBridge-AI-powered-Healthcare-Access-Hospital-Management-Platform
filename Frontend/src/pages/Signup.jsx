    ...
    <div>
      ...
      <section className="px-4 py-16 bg-gray-50 flex items-center justify-center min-h-[85vh]">
        <div className="w-full max-w-[500px] bg-white border border-gray-150 rounded-2xl shadow-sm p-8 md:p-10">
          ...
          {/* Clean Segmented Control for Role Selector */}
          <div className="grid grid-cols-2 gap-2 bg-gray-100 p-1.5 rounded-xl mb-6">
            <button
              type="button"
              onClick={() => setFormData({ ...formData, role: "patient", gender: "", taxId: "" })}
            ...
            <button
              type="button"
              onClick={() => setFormData({ ...formData, role: "org_admin", gender: "", taxId: "" })}
              className={`py-2.5 text-xs font-bold rounded-lg transition-all ${
          ...
          <form onSubmit={handleFormSubmit} className="space-y-4">
            ...
            {formData.role === "patient" ? (
              ...
              <div>
                <label className="text-xs font-bold text-headingColor block mb-1.5 uppercase tracking-wide">
                  Hospital License Number / Tax ID
                </label>
                <input
                  type="text"
                  placeholder="Enter Registration License Code"
                  name="taxId"
